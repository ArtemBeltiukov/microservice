...
class EmployeeAPIController {
    ...
    def describeEmployee(@PathVariable("id") String id) {
        ...
        [
                ...
                workspace: workspaceAPIClient.getWorkspaceById(employee.getWorkspaceId()) // null? Nope. Let's request exact workspace by employee.workspaceId from workspaces-api. How? With feign client maybe?
        ]
    }
}
